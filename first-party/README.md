...
```
emploke catalog install --origin https://github.com/LangSensei/emploke/tree/main/first-party/agents/dev
emploke catalog install --origin https://github.com/LangSensei/emploke/tree/main/first-party/skills/cli
```
