// Package copilot implements [task.Runtime] using GitHub Copilot CLI
// as the execution substrate.
//
// Copilot is a library, not a standalone service. It manages CLI processes,
// persists task state via [task.Repository], and provisions execution
// environments by consulting a [agent.AgentRegistry]. It does not own
...
// Import path:
//
//	import "github.com/LangSensei/emploke/runtime/copilot"
package copilot // import "github.com/LangSensei/emploke/runtime/copilot"
