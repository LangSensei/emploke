...
function WorkspaceLayout() {
   ...
   * render their own toolbars (Refresh / Dispatch / …) into it via
   * `<HeaderActions>` so the chrome header doubles as the page action
   * strip (no separate `.page-toolbar` row underneath).
   */
