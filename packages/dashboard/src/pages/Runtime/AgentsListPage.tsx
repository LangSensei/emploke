 ...
 *
 * The "legacy URL moved" banner that lived here under PR #189 polish
 * (Block C) moved to the new global Sessions/Tasks pages in Phase 1.5
 * (§4.1, Block F) — those pages are now the redirect target.
 */
